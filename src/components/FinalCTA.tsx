        ...
        >
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center justify-center gap-3 rounded-xl bg-accent-green px-8 py-4 text-sm font-bold uppercase tracking-wider text-black shadow-lg shadow-accent-green/30 hover:shadow-xl hover:shadow-accent-green/50"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.95 }}
              className="flex items-center justify-center gap-3 rounded-xl border-2 border-white/30 bg-black/20 px-8 py-4 text-sm font-bold uppercase tracking-wider text-white backdrop-blur-sm hover:border-white hover:bg-black/40"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col items-center justify-between gap-8 sm:flex-row">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center bg-accent-green rounded-lg">
                <span className="text-lg font-extrabold text-background">S</span>
              </div>
              <div className="flex flex-col">
                <span className="font-display text-base font-bold tracking-tight text-text leading-none">
                  ESPACIO
                </span>
